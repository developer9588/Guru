    ...
    return(
        <div className="wasp__table">
              <div className="search">
               ...
               <div className="overflow-table">
                ...
                {/* {MockData.filter(val =>{
                       ...
                       else if(val.Person.toLowerCase().includes(searchTerm.toLocaleLowerCase()) || val.Company_Name.toUpperCase().includes(searchTerm.toUpperCase()) ){
                         return val
                       }
                     }).map((m)=> (
                          <tr key={m.Person}>
            ...
            <div className="add-Client">
                  <button onClick={toggleModal} className="add-Client-btn"><span><i class="bi bi-plus"></i>Add New Client</span></button>
                  <button onClick={toggleInquiry} className="add-Client-btn"><span><i class="bi bi-plus"></i>Add New Enquiry</span></button>
                  {
                    modal && (
                      <div className="mod">
                                 ...
                                 <div className="search-form">
                                       <form>
                                           ...
                                           <div className="mod-btn">
                                                 <button className="mod-save">Save</button>
                                                 <button className="mod-save">Send Approval</button>
                                           </div>
                                       </form>
                                 </div>
                            </div>
                  ...
                  <div className="inquiry-form">
                                              ...
                                              <div className="inq-table">
                                                   ...
                                                   <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                  <input type="radio" className="inq-radio"  /> Partial <br />
                                                                  <input type="radio" className="inq-radio" /> Urgent <br />
                                                                  <input type="radio" className="inq-radio" /> Final
                                                            </td>
                                                            <td>
                        ...
                        <div className="inq-div-ad">
                             ...
                             <div className={`inq-div-3-content ${acOpen ? "inq-div-3-content-open" : ""}`}>
                                   ...
                                   <div className="work" onClick={toggleQuality}>
                                   ...
                                   <div className="work" onClick={toggleCancel}>
                                        <div className="work-content">
                                             ...
                                             <div className="quality-table">
                                                   ...
                                                   <tbody>
                                                        <tr>
                                                              <td>
                                                                    <input type="radio" className="work-radio" /> Correction <br />
                                                                    <input type="radio" className="work-radio" /> Cancellation
                                                              </td>
                                                              <td>
                                                                    <select>
                                                                          <option>Select</option>
